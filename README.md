...
python gen_all.py
```  
&ensp;&ensp;&ensp;&ensp; __Run Individually__. You can also use the following two commands to operate with every single image. Run the following command to get painterly style transfer.  
```
